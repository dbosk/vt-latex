...
own before a human coder verifies them (\cref{app:quiz-analysis}); no
account is sent to such a model before the processing terms are settled
in the review below.
...
\texttt{ethics-application-datintro26.md}) but not yet filed; no
collected data is used for research before the review is decided.
% XXX(#4) Ethics application for the datintro data collection: drafted,
% not yet filed; add the reference number and its terms once decided.
